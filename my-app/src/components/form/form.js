...
const Form = props => {
    return (
        <form className='form'>
             <p>Effective January 1st, 2020, Washington state will begin calculating real estate excise taxes (REET) based on a tier system. Find out how this could impact your plans for selling your home.</p>
